...
const Footer = () => {
  ...
  return (
    <div className='bg-black pt-10 lg:pt-20'>
      <Container>
        <div className='grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-6 gap-10 lg:gap-20 justify-between mb-10'>
          {/* First items */}
      ...
      <div className='py-6 text-center border-t border-[#515151]'>
        <p className='text-base font-normal text-white'>
          © { new Date().getFullYear() } Fardin Ahmed. All Rights Reserved.
        </p>
      </div>
    </div>
  )
